...
public class ORCFileViewer extends HdfsFileViewer {
     ...
     *
     * @see azkaban.viewer.hdfs.HdfsFileViewer#getCapabilities(org.apache.hadoop.fs.FileSystem,
     ...
     * @throws
     *
     * @see azkaban.viewer.hdfs.HdfsFileViewer#displayFile(org.apache.hadoop.fs.FileSystem,
     *      org.apache.hadoop.fs.Path, java.io.OutputStream, int, int)
     */
    @Override
     ...
     *
     * @see azkaban.viewer.hdfs.HdfsFileViewer#getSchema(org.apache.hadoop.fs.FileSystem,
     *      org.apache.hadoop.fs.Path)
     */
    @Override
