...
public class JSONUtil {
   ...
   * @throws IOException if the object can't be serialized as JSON or written 
	 * to the writer
   */
  public static void writeJson(ObjectMapper mapper, Writer writer, 
			Object object) throws IOException {
    mapper.writeValue(writer, object);
  }

  public static void writeJson(ObjectMapper mapper, String fileName, 
			Object object) throws IOException {
    Writer writer = new PrintWriter(fileName);
    try {
      writeJson(mapper, writer, object);
    } finally {
      writer.close();
    }
  }
   ...
   * @throws IOException
   */
  public static <T> T toObject(ObjectMapper mapper, String json, 
  ...
  public static void mixinAnnotatons(ObjectMapper mapper, Class<?> target, 
			Class<?> mixinSource) {
