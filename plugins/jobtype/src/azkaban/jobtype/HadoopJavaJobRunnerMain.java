...
public class HadoopJavaJobRunnerMain {
  ...
  public HadoopJavaJobRunnerMain() throws Exception {
    ...
    try {
      ...
      if (shouldProxy(prop)) {
        _javaObject = getObjectAsProxyUser(prop, _logger, _jobName, className, proxyUser);
      } else {
      ...
      try {
        final Method generatedPropertiesMethod =
            _javaObject.getClass().getMethod(GET_GENERATED_PROPERTIES_METHOD, new Class<?>[] {});
  ...
  private void runMethodAsUser(Properties prop, final Object obj, final String runMethod, final UserGroupInformation ugi)
