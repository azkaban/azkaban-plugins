...
class RealHiveQueryExecutor implements HiveQueryExecutor {
  private final static Logger LOG = Logger.getLogger("com.linkedin.hive.HiveQueryExecutor");
  ...
  public RealHiveQueryExecutor(HiveConf hiveConf, CliSessionState ss, CliDriver cli) throws Exception {
    ...
    // Expand out the hive aux jars since there was no shell script to do it for us
