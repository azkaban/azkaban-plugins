...
public class VisualizerPigJob extends JavaProcessJob {
...
//	public static String PIG_JAVA_CLASS = "org.apache.pig.Main";
	public static String PIG_WRAPPER = "azkaban.jobtype.VisualizerPigWrapper";
	...
	public VisualizerPigJob(String jobid, Props sysProps, Props jobProps, Logger log) throws IOException {
...
//		PIG_JAVA_CLASS = org.apache.pig.Main.class.getName();
	...
	private HadoopSecurityManager loadHadoopSecurityManager(Props props, Logger logger) throws RuntimeException {
		...
		Class<?> hadoopSecurityManagerClass = props.getClass(HADOOP_SECURITY_MANAGER_CLASS_PARAM, true, VisualizerPigJob.class.getClassLoader());
	...
	protected List<String> getClassPaths() {
		...
		classPath.add(getSourcePathFromClass(VisualizerPigWrapper.class));
