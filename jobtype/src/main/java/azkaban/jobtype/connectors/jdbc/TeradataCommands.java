...
public class TeradataCommands implements JdbcCommands {
   ...
   * {@inheritDoc}
   * @see azkaban.jobtype.connectors.jdbc.JdbcCommands#dropTable(java.lang.String, com.google.common.base.Optional)
   */
  @Override
   ...
   *
   * {@inheritDoc}
   * @see azkaban.jobtype.connectors.jdbc.JdbcCommands#truncateTable(java.lang.String, com.google.common.base.Optional)
   */
  @Override
